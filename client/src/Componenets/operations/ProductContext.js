...
export function ProductProvider({ children }) {
  ...
  const fetchFavs = async () => {
    ...
    try {
      const response = await fetch("http://localhost:4500/api/favourites", {
        headers: {
  ...
  const remove_fav = async (product) => {
    ...
    try {
      const response = await fetch(
        `http://localhost:4500/api/favourites/${product.title}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
...
const remove_cart = async (product) => {
  ...
  try {
    const response = await fetch(`http://localhost:4500/api/cart/${productId}`, {
      method: "DELETE",
      headers: {
        Authorization: `Bearer ${token}`,
      },
...
const increase_quantity = async (product) => {
  ...
  try {
    const res = await fetch(`http://localhost:4500/api/cart/increase/${productId}`, {
      method: "PATCH",
      headers: {
        Authorization: `Bearer ${token}`,
      },
...
const decrease_quantity = async (product) => {
  ...
  try {
    const res = await fetch(`http://localhost:4500/api/cart/decrease/${productId}`, {
      method: "PATCH",
      headers: {
        Authorization: `Bearer ${token}`,
      },
...
const clear_cart = async () => {
  ...
  try {
    const res = await fetch("http://localhost:4500/api/cart", {
      method: "DELETE",
      headers: {
        Authorization: `Bearer ${token}`,
      },
