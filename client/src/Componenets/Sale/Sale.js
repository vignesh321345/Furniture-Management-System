...
function Sale({ user }) {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                const response = await fetch(" https://furniture-management-system-3.onrender.com/api/products");
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(" https://furniture-management-system-3.onrender.com/api/upload", {
                method: "POST",
                body: formData,
                headers: {
            ...
            <div className="sales-list">
                ...
                {products.length > 0 ? products.map((product) => (
                    <Main key={product._id} product={{
                        ...product,
                        imageUrl: ` https://furniture-management-system-3.onrender.com/${product.filename}`
                    }} />
